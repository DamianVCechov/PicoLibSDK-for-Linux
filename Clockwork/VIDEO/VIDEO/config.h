...
// 									FOR CLOCKWORK MUST BE USE_VIDEO 0
#define USE_VIDEO			0		// use video player - it will disable default frame buffer (lib_video.c, lib_video.h)
#define USE_FRAMEBUF 		0
#define ILI9488_USE_16BIT_SPI 	1	// simulate 16 bit communication RGB 5-6-5 on 18 bit RGB 6-6-6
