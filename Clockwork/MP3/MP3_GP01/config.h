...
#define PWMSND_GPIO		26		// PWM sound output GPIO pin (left or single channel)
#define PWMSND_GPIO_R		27		// PWM sound output GPIO pin (right channel; -1 = not used, only single channel is used)
