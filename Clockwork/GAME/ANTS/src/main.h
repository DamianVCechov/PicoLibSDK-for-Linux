...
extern const u8 BackgroundImg[51200] __attribute__ ((aligned(4)));
...
extern const u8 OpenSel2Img[1200] __attribute__ ((aligned(4)));

// format: 4-bit paletted pixel graphics
// image width: 40 pixels
// image height: 40 lines
// image pitch: 20 bytes
extern const u16 OpenSel3Img_Pal[16] __attribute__ ((aligned(4)));
extern const u8 OpenSel3Img[800] __attribute__ ((aligned(4)));
